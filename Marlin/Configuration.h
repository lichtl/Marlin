...
#define STRING_CONFIG_H_AUTHOR "(lichtl, default config)" // Who made the changes.
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Autotune V2 Bowden E3D V6 Full
 #define  DEFAULT_Kp 37.87
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80*(20/20.1) ,80*(20/20.1), 4000*(20/20.05), 147} 
...
#define DEFAULT_MAX_FEEDRATE          {250, 250, 2, 150}
/**
...
#define DEFAULT_MAX_ACCELERATION      {1500,1500,100/3,1800}
/**
